...
[task model](agentic/kaj-agentic-tasks-spec.md), and named
[steps and lifecycle](agentic/kaj-agentic-steps-and-lifecycle-spec.md), and
...
- **Trying Agentic Kaj?** Start with the implemented [Tasks](agentic/kaj-agentic-tasks-spec.md).
